...
class TestTaskWithOneIntValidationParameter(unittest.TestCase):
    ...
    def test_TaskWithOneIntValidationParameter_validate_data_exception(self, input_number, expected_exception):
        self.assertRaises(
            expected_exception, algo.TaskWithOneIntValidationParameter.validate_data, input_number)
...
class TestTask87(unittest.TestCase):
    ...
    def test_main_logic(self, number, quantity, expected_value):
        self.assertEqual(algo.Task87.main_logic(
...
class TestTask226(unittest.TestCase):
    ...
    def test_main_logic(self, number1, number2, expected_value):
        self.assertEqual(algo.Task226.main_logic(
...
class TestTask555(unittest.TestCase):
    ...
    def test_task555(self, input_value, expected_value):
        self.assertEqual(
            [*algo.Task555.main_logic(input_value)], expected_value)
...
class TestTask330(unittest.TestCase):
    ...
    def test_task330_main_logic(self, number, expected_value):
        self.assertEqual([x for x in algo.Task330.main_logic(number)], expected_value)